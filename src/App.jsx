...
Saya ingin membuat tempahan untuk Lavender Villa Melaka pada tarikh di atas. Sila sahkan ketersediaan. Terima kasih!`;
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      {/* Floating WhatsApp Button - Bottom on mobile, Right side on desktop */}
      <a
        href="https://wa.me/60193345686?text=Hai%2C%20saya%20ingin%20bertanya%20tentang%20Lavender%20Villa%20Melaka"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-4 left-1/2 -translate-x-1/2 sm:left-auto sm:translate-x-0 sm:bottom-6 sm:right-6 z-40 group"
      >
        {/* Tooltip - Hidden on mobile */}
        <div className="hidden sm:block absolute bottom-full right-0 mb-3 opacity-0 group-hover:opacity-100 transition-all duration-300 transform group-hover:translate-y-0 translate-y-2 pointer-events-none">
        ...
        {/* Mobile: Full width bar style / Desktop: Circle button */}
        <div className="sm:hidden flex items-center gap-3 bg-gradient-to-r from-green-500 to-green-600 text-white px-6 py-3 rounded-full shadow-xl active:scale-95 transition-transform">
          ...
          <span className="font-semibold text-sm">WhatsApp Kami</span>
        </div>
        
        {/* Desktop: Circle button with liquid glass effect */}
        <div className="hidden sm:block relative">
          ...
          <div className="relative w-16 h-16 bg-gradient-to-br from-green-400 to-green-500 rounded-full flex items-center justify-center shadow-xl group-hover:scale-110 transition-all duration-300 group-hover:shadow-green-500/50 group-hover:shadow-2xl">
            {/* Glass overlay */}
